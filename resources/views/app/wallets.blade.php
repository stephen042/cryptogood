        ...
        <div class="p-4 my-4">
            ...
            <div class="bg-gray-800 p-3 mb-4 flex items-center justify-between" style="height:98px;border-radius:10px;">
                ...
                <div class="text-right mx-2">
                    ...
                    <div class="text-sm" style="color: #34D399;">+{{ Auth::user()->account->bitcoin_balance * 1.05 }}%
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-800 p-3 mb-4 flex items-center justify-between" style="height:98px;border-radius:10px;">
                ...
                <div class="text-right mx-2">
                    ...
                    <div class="text-sm" style="color: #34D399;">+{{ Auth::user()->account->ethereum_balance * 1.98 }}%
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-800 p-3 mb-4 flex items-center justify-between" style="height:98px;border-radius:10px;">
                ...
                <div class="text-right mx-2">
                    ...
                    <div class="text-sm" style="color: #34D399;">+{{ Auth::user()->account->usdt_balance * 2.98 }}%
                    </div>
                </div>
            </div>
