<header 
    class="sticky top-0 z-50 flex w-full bg-gray-900 lg:border-b border-gray-800"
>
    <div class="flex grow items-center justify-between px-4 py-3 lg:px-6 lg:py-4">
        
        <!-- Left: Gear link (20% bigger, white) -->
        <a href="#settings"
           class="flex h-12 w-12 items-center justify-center rounded-lg text-white lg:h-13 lg:w-13">
        ...
        <!-- Right: Missions link (15% bigger, light blue background, white text) -->
        <a href="#missions"
           class="flex items-center gap-2 rounded-full px-3 py-2 text-sm border border-blue-500 bg-blue-600 text-white">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg" class="shrink-0 text-white">
            ...
            <span class="text-base font-medium">Missions</span>
        </a>
