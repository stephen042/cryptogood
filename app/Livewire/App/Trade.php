...
class Trade extends Component
{
    ...
    public function trade($buy_sell)
    {
        ...
        if ($store) {
            ...
            try {
                ...
                $this->dispatch('notify', type: 'success', message: 'Trade placed successfully!');
            } catch (\Throwable $th) {
                $this->dispatch('notify', type: 'error', message: 'Trade placement failed.');
            }
    ...
    {
        return view('livewire.app.trade');
    }
}
