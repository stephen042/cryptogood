...
@if ($adminMessage && $adminMessage->message && $adminMessage->title)
    <div id="adminMessageModal"
         style="position: fixed; inset: 0; background-color: rgba(0,0,0,0.7); display: flex; align-items: flex-start; justify-content: center; z-index: 9999; backdrop-filter: blur(4px); padding-top: 140px;">
