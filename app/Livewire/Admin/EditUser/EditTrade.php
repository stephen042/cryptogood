...
class EditTrade extends Component
{
    ...
    public function deleteTrade($tradeId)
    {
        ...
        $trade->delete();
        $this->dispatch('notify',type: 'success', message:'Trade deleted successfully');
    }
    ...
    public function completeTrade($tradeId)
    {
        ...
        if (is_null($profit) && is_null($loss)) {
            $this->dispatch('notify',type: 'error', message:'Please enter a profit or a loss value.');
            return;
        }
        ...
        if (!is_null($profit)) {
            $this->user->earnings_balance += $profit;
        ...
        $this->dispatch('notify',type: 'success', message:'Trade completed successfully');
    }
